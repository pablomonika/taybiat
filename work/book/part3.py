...
def _simple_ban_table(items):
    x = ['<table class="food"><thead><tr><th>المنتج</th><th class="c" style="width:22%">الحالة</th></tr></thead><tbody>']
    for it in items:
...
""")
    ...
    for num, title, kind, items, note in BANNED:
        ...
        if kind == "flour":
            ...
            h.append('<table class="food"><thead><tr><th>النوع</th><th style="width:52%">السبب</th></tr></thead><tbody>')
        ...
        if kind == "dairy":
            ...
            h.append('<table class="food"><thead><tr><th>المنتج</th><th style="width:50%">السبب</th></tr></thead><tbody>')
            ...
            h.append('<table class="food"><thead><tr><th>المنتج</th><th class="c" style="width:22%">الحالة</th></tr></thead><tbody>')
            ...
            h.append('<table class="food"><thead><tr><th>المنتج</th><th style="width:50%">ملاحظة</th></tr></thead><tbody>')
            for p, r in items:
                h.append(f'<tr><td><strong>{p}</strong></td><td class="small">{r}</td></tr>')
            h.append('</tbody></table>')
            ...
            h.append('<table class="food"><thead><tr><th>المنتج</th><th style="width:46%">الحالة / ملاحظة</th></tr></thead><tbody>')
